    ...
    return <section className="mail-aside" >
        <nav>
            <ul>
                ...
                <li > <NavLink activeClassName="selected"  className="nav-link-aside" onClick={() =>  onRouteClick ('inbox')} exact to="/mail/"><span className="fa inbox"></span> inbox </NavLink></li>
                <li ><NavLink activeClassName="selected" className="nav-link-aside" onClick={() =>  onRouteClick ('trash')} exact to="/mail/"><span className="fa trash"></span> trash</NavLink></li>
                <li ><NavLink activeClassName="selected" className="nav-link-aside" onClick={() =>  onRouteClick ('draft')} exact to="/mail/"> <span className="far sent"></span>draft</NavLink></li>
